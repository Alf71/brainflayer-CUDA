...
*/
__device__ void sr25519_keypair_from_seed(sr25519_keypair keypair, const sr25519_mini_secret_key seed);

/*
 * keypair: the output uniform keypair, 96 bytes long
 * seed: the input mini secret key, 32 bytes long
*/
__device__ void sr25519_uniform_keypair_from_seed(sr25519_keypair keypair, const sr25519_mini_secret_key seed);
...
*/
__device__ void sr25519_sign(sr25519_signature signature, const sr25519_public_key public_key, const sr25519_secret_key secret, const uint8_t *message, unsigned long message_length);
...
*/
__device__ void sr25519_derive_keypair_soft(sr25519_keypair derived, const sr25519_keypair keypair, const sr25519_chain_code chain_code);
 ...
 * chain_code: the input chain code, 32 bytes long
*/
__device__ void sr25519_derive_public_soft(sr25519_public_key derived_public, const sr25519_public_key public_key, const sr25519_chain_code chain_code);
 ...
 * chain_code: the input chain code, 32 bytes long
*/
__device__ void sr25519_derive_keypair_hard(sr25519_keypair derived, const sr25519_keypair keypair, const sr25519_chain_code chain_code);
