...
__device__ static const size_t limb128bits = (128 + bignum256modm_bits_per_limb - 1) / bignum256modm_bits_per_limb;

typedef size_t heap_index_t;

__device__ typedef struct batch_heap_t {
...
__device__ unsigned char batch_point_buffer[3][32];
