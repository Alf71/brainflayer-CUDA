...
#ifdef GPU_CONSTANTS_DEFINITIONS
...
extern __device__ __constant__ uint64_t _beta[4];
extern __device__ __constant__ uint64_t _beta2[4];
#endif
...
static __device__ void IMult(uint64_t* r, uint64_t* a, int64_t b) {
    ...
    __align__(16) uint64_t t[NBBLOCK];
...
static __device__ void ModSub256(uint64_t* r, uint64_t* a, uint64_t* b) {
    uint64_t borrow;
    __align__(16) uint64_t p[4] = { 0xFFFFFFFEFFFFFC2FULL, 0xFFFFFFFFFFFFFFFFULL,
...
// Device helper: ModSub256isOdd.
static __device__ void ModSub256isOdd(uint64_t* a, uint64_t* b, uint8_t* parity) {    //no need to compute py, we need only parity
...
static __device__ __noinline__ void _ModInv(uint64_t* R) {
    ...
    __align__(16) uint64_t u[NBBLOCK];
    __align__(16) uint64_t v[NBBLOCK];
    __align__(16) uint64_t r[NBBLOCK];
    __align__(16) uint64_t s[NBBLOCK];
    __align__(16) uint64_t tr[NBBLOCK];
    __align__(16) uint64_t ts[NBBLOCK];
    __align__(16) uint64_t r0[NBBLOCK];
    __align__(16) uint64_t s0[NBBLOCK];
    uint64_t carryR;
    uint64_t carryS;
