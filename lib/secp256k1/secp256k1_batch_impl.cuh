...
extern __device__ __align__(16) secp256k1_ge P0_global;  // k0 * G
extern __device__ __align__(16) secp256k1_ge H_global;   // step * G / -step * G 
...
template<int KEYS>
struct __align__(16) secp256k1_walk_chunk_scratch_mul {
...
__device__ void secp256k1_walk_emit_chunk_uncompressed_ct(
    ...
    unsigned char* __restrict__ out_pubkeys65)
{
    __align__(16) secp256k1_walk_chunk_scratch_mul<KEYS> scr;
...
{
    __align__(16) secp256k1_gej P;
    secp256k1_walk_get_start_gej(&P, starter);

    __align__(16) unsigned char pubChunk[KEYS * 65];
